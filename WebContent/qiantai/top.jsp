							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="${empty user ?'qiantai/login.jsp':'qiantai/order.jsp' }" target="_self">我的订单</a></li>
										<li><a href="${empty user ?'qiantai/login.jsp':'qiantai/center.jsp' }" target="_self">用户中心</a></li>

										<li><a href="${empty user ?'qiantai/login.jsp':'qiantai/carry.jsp' }" target="_self">配送说明</a></li>

										<li><a href="${empty user ?'qiantai/login.jsp':'qiantai/our.jsp' }" target="_self">关于我们</a></li>

										<li><a href="${empty user ?'qiantai/login.jsp':'usersServlet?action=logout' }">注销退出</a></li>
